...
namespace ImageCapture
{
    ...
    public abstract class CaptureBase
    {
        ...
        public delegate void ProcessExTriggerHandler(string strCmd, string[] paramList, HObject[] image);
        ...
        /// 图片队列
        /// </summary>
        protected ConcurrentQueue<HObject> Images = new ConcurrentQueue<HObject>();
        ...
        /// 外部触发
        /// </summary>
        public bool ExTrigger
        {
            get { return _exTrigger; }
            set { _exTrigger = value; }
        }
        ...
        /// <returns></returns>
        public HObject GetImage(bool isRemove = false)
        {
            HObject image;
        ...
        /// </summary>
        /// <returns></returns>
        public HObject[] GetImages()
        {
            HObject[] images = Images.ToArray();
        ...
        /// </summary>
        /// <param name="image"></param>
        protected void OnHandlerImage(HObject[] image)
        {
